...
bool setupShadersAndVertex(uint *shaderProgram, uint *VAO1, uint *VAO2);
...
int main()
{
    ...
    uint shaderProgram, VAO1, VAO2;

    if (!setupShadersAndVertex(&shaderProgram, &VAO1, &VAO2)) return -1;
