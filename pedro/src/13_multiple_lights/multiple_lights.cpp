...
void setLights(Shader &shader) {
    ...
    // Directional light
    shader.setVec3("dirLight.direction", standardLight.direction);
    shader.setVec3(  "dirLight.ambient", standardLight.ambient / 2.0f);
    shader.setVec3(  "dirLight.diffuse", standardLight.diffuse / 2.0f);
    shader.setVec3( "dirLight.specular", standardLight.specular);
    ...
    for (size_t i = 0; i < 4; i++)
    {
        ...
        shader.setVec3 ((pointLight +  ".position").c_str(), pointLightPositions[i]);
        shader.setVec3 ((pointLight +   ".ambient").c_str(), standardLight.ambient / 2.0f);
        shader.setVec3 ((pointLight +   ".diffuse").c_str(), standardLight.diffuse);
        shader.setVec3 ((pointLight +  ".specular").c_str(), standardLight.specular);
        shader.setFloat( (pointLight + ".constant").c_str(), standardLight.constant);
        shader.setFloat( (pointLight +   ".linear").c_str(), standardLight.linear);
        shader.setFloat((pointLight + ".quadratic").c_str(), standardLight.quadratic);
    }
    ...
    shader.setVec3(     "spotlight.ambient", standardLight.ambient);
    shader.setVec3(     "spotlight.diffuse", standardLight.diffuse);
    shader.setVec3(    "spotlight.specular", standardLight.specular);

    shader.setFloat(   "spotlight.constant", standardLight.constant);
    shader.setFloat(     "spotlight.linear", standardLight.linear);
    shader.setFloat(  "spotlight.quadratic", standardLight.quadratic);
