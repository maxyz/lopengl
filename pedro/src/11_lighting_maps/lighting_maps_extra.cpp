...
int main()
{
    ...
    Texture2D containerTexture("../media/face.jpg", JPG);
    Texture2D specularMap("../media/face_specular.jpg", JPG);
    Texture2D emissionMap("../media/red_eyes.jpg", JPG);
    lightingShader.use();
    ...
    glm::mat4 source_rotation = glm::rotate(glm::mat4(1.0f), (float)glm::radians(0.5), glm::vec3(0.0f,1.0f,0.0f));
