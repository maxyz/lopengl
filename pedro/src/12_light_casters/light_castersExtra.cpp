...
int main()
{
    ...
    // Setup Shaders
    Shader lightingShader("shaders/lightShader01.vs", "shaders/lightShaderExtra.frag");
    ...
    Texture2D lightCookie("../media/cookie.png", PNG);
    lightingShader.use();
    lightingShader.setInt("material.diffuse", 0);
    lightingShader.setInt("material.specular", 1);
    lightingShader.setInt("material.emission", 2);
    lightingShader.setInt("light.texture", 3);
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        lightingShader.setMat4("projViewMat", projection * view);
...
void setLight(Shader &shader, const Light &light) {
    ...
    shader.setFloat("light.cutOff",   glm::cos(glm::radians(19.5f)));
