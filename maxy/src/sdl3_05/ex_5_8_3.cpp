...
create_pipeline(engine_t const &engine, std::string_view frag_spv) {
    auto vert =
    ...
    auto frag = load_shader(engine, frag_spv, SDL_GPU_SHADERSTAGE_FRAGMENT);
...
int main(int argc, char *argv[]) {
    ...
    auto orange_result = create_pipeline(engine, "shaders/sdl3_05/hello_triangle.frag.spv");
    if (!orange_result) {
    ...
    auto yellow_result = create_pipeline(engine, "shaders/sdl3_05/ex_5_8_3_yellow.frag.spv");
    if (!yellow_result) {
