// Exercise 10.10.1: FPS camera -- W/S/A/D stays on XZ plane; looking up/down does not affect
// movement.
#include <print>
#include <string>
...
int main(int argc, char *argv[]) {
    ...
    auto engine_result =
        create_engine("SDL3 ex 10.10.1 - FPS Camera", WINDOW_WIDTH, WINDOW_HEIGHT, config);
    if (!engine_result) {
    ...
    auto pipeline_result = create_pipeline(
        engine, {
                    .vertex_shader          = "shaders/sdl3_10/ex_10_10_1.vert.spv",
                    .fragment_shader        = "shaders/sdl3_10/ex_10_10_1.frag.spv",
