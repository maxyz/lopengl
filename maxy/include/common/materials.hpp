...
constexpr material_t turquoise = {
...
constexpr material_t gold = {
    ...
    .shininess = 0.4 * max_shininess,
};

constexpr material_t silver = {
...
constexpr material_t black_plastic = {
    .ambient = glm::vec3(0.0, 0.0, 0.0),
    .diffuse = glm::vec3(0.01, 0.01, 0.01),
    .specular = glm::vec3(0.50, 0.50, 0.50),
    .shininess = 0.25 * max_shininess,
};

constexpr material_t cyan_plastic = {
...
constexpr material_t green_plastic = {
    .ambient = glm::vec3(0.0, 0.0, 0.0),
...
constexpr material_t red_plastic = {
    .ambient = glm::vec3(0.0, 0.0, 0.0),
...
constexpr material_t white_plastic = {
    .ambient = glm::vec3(0.0, 0.0, 0.0),
...
constexpr material_t yellow_plastic = {
    .ambient = glm::vec3(0.0, 0.0, 0.0),
...
constexpr material_t black_rubber = {
    .ambient = glm::vec3(0.02, 0.02, 0.02),
    .diffuse = glm::vec3(0.01, 0.01, 0.01),
    .specular = glm::vec3(0.4, 0.4, 0.4),
    .shininess = 0.078125 * max_shininess,
};

constexpr material_t cyan_rubber = {
    .ambient = glm::vec3(0.0, 0.05, 0.05),
    .diffuse = glm::vec3(0.4, 0.5, 0.5),
    .specular = glm::vec3(0.04, 0.7, 0.7),
    .shininess = .078125 * max_shininess,
};

constexpr material_t green_rubber = {
...
constexpr material_t red_rubber = {
...
constexpr material_t white_rubber = {
...
constexpr material_t yellow_rubber = {
