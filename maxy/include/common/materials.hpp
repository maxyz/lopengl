...
const material_t green_plastic = {.ambient = glm::vec3(0.0, 0.0, 0.0),
                                  .diffuse = glm::vec3(0.1, 0.35, 0.1),
                                  .specular = glm::vec3(0.45, 0.55, 0.45),
                                  .shininess = 0.25};

const material_t red_plastic = {.ambient = glm::vec3(0.0, 0.0, 0.0),
                                .diffuse = glm::vec3(0.5, 0.0, 0.0),
                                .specular = glm::vec3(0.7, 0.6, 0.6),
                                .shininess = 0.25};

const material_t white_plastic = {.ambient = glm::vec3(0.0, 0.0, 0.0),
                                  .diffuse = glm::vec3(0.55, 0.55, 0.55),
                                  .specular = glm::vec3(0.70, 0.70, 0.70),
                                  .shininess = 0.25};

const material_t yellow_plastic = {.ambient = glm::vec3(0.0, 0.0, 0.0),
...
const material_t cyan_rubber = {.ambient = glm::vec3(0.0, 0.05, 0.05),
...
const material_t red_rubber = {.ambient = glm::vec3(0.05, 0.0, 0.0),
                               .diffuse = glm::vec3(0.5, 0.4, 0.4),
                               .specular = glm::vec3(0.7, 0.04, 0.04),
                               .shininess = .078125};

const material_t white_rubber = {.ambient = glm::vec3(0.05, 0.05, 0.05),
                                 .diffuse = glm::vec3(0.5, 0.5, 0.5),
                                 .specular = glm::vec3(0.7, 0.7, 0.7),
                                 .shininess = .078125};

const material_t yellow_rubber = {.ambient = glm::vec3(0.05, 0.05, 0.0),
