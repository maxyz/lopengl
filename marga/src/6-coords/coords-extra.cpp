...
int main()
{
    ...
    Texture texture1 = Texture("../media/easter-egg-frame-art.jpg", GL_RGB);
    Texture texture2 = Texture("../media/EasterEgg2.png", GL_RGBA);

    // Read shaders
    Shader ourShader("shaders/vertex.glsl", "shaders/extra-fragment.glsl");
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        for(unsigned int i = 0; i < 10; i++)
        {
            ...
            if ( i < 5) {
                ourShader.setVec4f("ourColor", glm::value_ptr(glm::vec4(1.0f - 0.2f*i, 0.1f+0.15f*i, 0.6f-0.05*i, 1.0f)));
            } else {
                ourShader.setVec4f("ourColor", glm::value_ptr(glm::vec4(-0.2f + 0.05f*i, 1.1f-0.1f*i, 0.4f+0.01*i, 1.0f)));
            }
