...
void processInput(GLFWwindow *window, float deltaTime, Camera &camera, Lighting &light)
{
...
int main()
{
    ...
    // Read shaders
    Shader ourShader("shaders/lighting-vertex.glsl", "shaders/parameters-fragment.glsl");
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        // input
        processInput(window, deltaTime, camera, light);
