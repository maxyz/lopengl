...
void SceneRenderer::createShaders()
{
    ...
    this->sceneShader = new Shader("shaders/points-vertex.glsl", "shaders/points-frag.glsl");
}
...
void SceneRenderer::init()
{
    ...
    this->pointColor = glm::vec3( 0.6f,  0.4f,  0.1f);
}
...
void SceneRenderer::renderScene(SceneState &state) 
{
    ...
    this->sceneShader->setVec3f("pointColor", glm::value_ptr(this->pointColor));
...
void SceneRenderer::showImGuiControls(SceneState &state) {
    ...
    ImGui::ColorEdit3("Point Color", glm::value_ptr(this->pointColor));
}
