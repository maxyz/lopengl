...
int main()
{
    ...
    // Read shaders
    Shader ourShader("shaders/texture-vertex.glsl", "shaders/emission-fragment.glsl");
    ...
    Texture emissionMap = Texture("../media/matrix.jpg", GL_RGB);
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        ourShader.setFloat("time", (float)glfwGetTime()/2);
