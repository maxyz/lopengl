...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(INITIAL_WIDTH, INITIAL_HEIGHT, "Stencil testing", NULL, NULL);
    if (window == NULL)
    {
    ...
    Shader singleColorShader("shaders/vertex.glsl", "shaders/single-color.glsl");
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        // Draw the 2 cubes scaled up
        singleColorShader.setMatrix4fv("view", glm::value_ptr(view));
